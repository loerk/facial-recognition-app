            ...
            <main className="pa4 black-80">
                <div className="measure">
                    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                        <legend className="f4 white center fw6 ph0 mh0">Register</legend>
                        <div className="mt3">
                    ...
                    <div className="center">
                        <input onClick={() => onRouteChange("HOME")} className="b white ph3 pv2 input-reset ba  bg-transparent grow pointer f6 dib" type="submit" value="Register" />
                    </div>
                </div>
            </main>
        </article>
